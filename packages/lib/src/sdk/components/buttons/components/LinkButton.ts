...
class LinkButton extends BaseButton {
    ...
    public setLabel(label: string): this {
        this.label = LinkButton.assertLabel(label, this.emoji !== undefined)
        return this
    }
    ...
    public setEmoji(emoji: IPartialEmoji): this {
        if (this.label !== undefined) LinkButton.assertLabel(this.label, true)
        this.emoji = emoji
        return this
    }
    ...
    public toJSON(): Record<string, unknown> {
        ...
        LinkButton.assertLabelOrEmoji(this.label, this.emoji)
